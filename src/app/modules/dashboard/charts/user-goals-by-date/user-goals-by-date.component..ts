...
@Component({
  selector: 'app-user-goals-by-date-chart',
...
export class UserGoalsByDateChartComponent extends DashboardChartComponent implements OnInit {

  constructor(protected reportRequestService: ReportRequestService, protected reportDataService: ReportDataService) {
    super('userGoalByDate', reportRequestService, reportDataService);
  }
