...
export class UploadFileService {
  ...
  getImportRedirectUrl(brokerageUid: string) {
    return this.httpService.getWIthReponseType(environment.apiUrl + '/import/user/redirect-url/' + brokerageUid, new Map(), new Map());
  }
